...
execute if entity @s[gamemode=!creative,gamemode=!spectator,scores={mana=1..}] run execute if score @s element matches 1.. run scoreboard players remove @s mana 1
execute if entity @s[scores={mana=..0}] run execute if score @s element matches 1.. run tellraw @s "§cNot enough mana"
